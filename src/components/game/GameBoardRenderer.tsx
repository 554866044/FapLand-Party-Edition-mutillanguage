...
function drawTile(
    ...
    g.poly([
        x, y + TILE_H,
        x + TILE_W, y + TILE_H,
        x + TILE_W, y + TILE_H + TILE_DEPTH,
        x, y + TILE_H + TILE_DEPTH,
    ]);
    g.fill(c.side);
    ...
    g.poly([
        x + TILE_W, y,
        x + TILE_W + TILE_DEPTH_SIDE, y - TILE_DEPTH_SIDE * 0.5,
        x + TILE_W + TILE_DEPTH_SIDE, y + TILE_H - TILE_DEPTH_SIDE * 0.5,
        x + TILE_W, y + TILE_H,
    ]);
    g.fill(c.sideR);
    ...
    const topColor = isActive
        ? blendColor(c.top, 0xffffff, 0.2 + 0.12 * pulse)
        : c.top;
...
export const GameBoardRenderer = memo(function GameBoardRenderer({
    ...
    const handleOver = useCallback(
        (e: FederatedPointerEvent, field: BoardField) => {
