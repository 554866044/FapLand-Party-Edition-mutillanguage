    ...
    return (
      <div className="space-y-3 p-3">
        ...
        <div className="space-y-3 rounded-xl border border-zinc-700/40 bg-zinc-950/40 p-3">
          ...
          <div className="rounded-lg border border-zinc-700/40 bg-zinc-950/60 p-3">
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-[11px] text-zinc-600">
                  <Trans>
                    Move the player instantly after each roll instead of playing the dice and
                    movement animation.
                  </Trans>
                </p>
              </div>
              <button
                type="button"
                aria-label={t`Disable dice animation`}
                onMouseEnter={playHoverSound}
                onClick={() => onSetDisableDiceAnimation(!disableDiceAnimation)}
              ...
              >
                {disableDiceAnimation ? <Trans>Enabled</Trans> : <Trans>Disabled</Trans>}
              </button>
            </div>
          </div>
        </div>
